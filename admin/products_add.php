              ...
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputText1" name="title_en" required>
                  </div>
                  ...
                  <div class="mb-3">
                    <label for="exampleInputText1" class="form-label">المحتوى بالعربي</label>
                  ...
                  <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" cols="30" rows="10" id="summernote_en" name="desc_en" required></textarea>
                  </div>


                  <div class="mb-3">
                    <label for="exampleInputText1" class="form-label"> كاتب المقال بالعربي</label>
                    <input type="text" class="form-control" id="exampleInputText1" name="postAuthor" required>
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputText1" class="form-label"> كاتب المقال بالانكليزي</label>
                    <input type="text" class="form-control" id="exampleInputText1" name="postAuthor_en" required>
                  </div>
                  ...
                  <button type="submit" class="btn btn-primary" name="post_add_btn">ارسال</button>
                </form>
              </div>
              <!-- /.card-body -->
            </div>
  ...
  ?>
    ...
    ?>
      ...
      if ($size < 5000000) {
        ...
        $exit = "SELECT * FROM posts where postTitle = '$title' OR postTitle_en = '$title_en'";
      ...
      ?>
          ...
          $query = "INSERT INTO  posts (postTitle , postTitle_en , postCat, postImage , postContent , postContent_en , postAuthor , postAuthor_en , status ) VALUES ('$title' ,'$title_en','$cat_name','$img','$desc','$desc_en','$postAuthor','$postAuthor_en','1')";
